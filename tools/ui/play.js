...
export const STAGE = {
  // ⚠️ Шаги КЛИЕНТА — тоже работа, и долгая. Без них окно молчало всё время, пока ffmpeg
  // достаёт звук из двухгигабайтного видео (живьём — три минуты «ничего не происходит»).
  audio: { w: 4, say: "достаю звук из видео", typical: 120 },
  voices: { w: 1, say: "снимаю отпечатки голосов", typical: 30 },
  record: { w: 1, say: "собираю черновик записи", typical: 15 },
  screen: { w: 8, say: "разбираю экран из видео", typical: 300 },
  pack: { w: 1, say: "собираю пакет", typical: 20 },
  send: { w: 2, say: "отправляю на сайт", typical: 90 },
